    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="sm" asChild>
          <Link href="/admin/delegates" className="flex items-center gap-2">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Complete delegate information and form submission status
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Assigned supervisor for this delegate
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            {delegate.hasForm ? (
              <div className="space-y-3">
                ...
                {delegate.form && (
                  <div className="mt-4">
                    <Button asChild>
                      <Link href={`/admin/forms/${delegate.form.id}`}>
                        View Form Details
                      </Link>
                    </Button>
                  </div>
